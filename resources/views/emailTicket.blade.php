...
<body>
  <div style="background:#f5f7ff; padding:20px 0;">
    <div class="container">
        <div class="od-body mb25" style="background:#112f77; border-radius:0px ; border-top-left-radius:8px; border-top-right-radius:8px; margin-top: 0px; margin-bottom: 0px; padding-bottom: 0px; padding-top: 0; padding-left: 0px; padding-right: 0px;">
           <div class="row mb40">
               <div class="col-md-7 mid-10" style="padding-left: 15px; text-align: left;"><img src="{{url('public/template/logo.png')}}" style="margin-top:15px;" class="od-logo"/><br/>
               <span style="color:#ffffff;"><strong>ODBus Ticket Information</strong></span></div>
               <div class="col-md-5 odtext32" style="padding-right: 15px;">
                  <div class="od-qrcode" style="float: right; width:80px; margin-bottom: 5px;">
        ...
        <div class="row mt30">
            <div class="col-md-12 odtext24"></div>
          </div>
        <div class="row">
            <div class="col-md-12">
              <div class="odbox1">
...
<li>Bus owners not providing In-bus amenities/facilities mentioned while booking.
...
<p style="font-size: 12px">The tickets booked through ODBUS Can be cancelled and note that Cancel Can be possible before 12 hours of the departure of the said bus.</p>
<ol>
