...
<body style="background: #eaf0f6; margin: 0; padding: 0; min-width: 100%!important; font-family: 'Lato', sans-serif;">
...
<strong>Email:<a href="mailto:support@odbus.in" style="color:#fff; text-decoration:none;" > support@odbus.in</a></strong></p>
  ...
  <table style="text-align: center; background: #f0c000; max-width: 700px; margin:0 auto;  width: 100%; border-collapse: collapse;" >
    <tr >
      <td style="font-size:30px; padding: 20px 0px; color:#323232"><b>Feedback Email from ODBUS</b></td>
    </tr>
  </table>
  <table style="text-align: center; background: #fff; max-width: 700px; margin:0 auto;  padding:60px 50px 0px; width: 100%; border-collapse: collapse;" >
    ...
    <tr>
      ...
      <p>Your feedback is utmost important for us because we strive hard to build a business of trust & relationship We'll leave no stone unturned to serve our customers <b>Better than Before...</b></p>
      </td>
    </tr>

    <tr style="text-align: left;"><td style="padding:0px 50px; line-height:25px"><strong>Regards,</strong> <br><b>Team ODBUS</b></td></tr>
    
    <tr style="height:50px;"></tr>
    
  </table>
 
  <table style="text-align: center; background: #014; max-width: 700px; margin:0 auto; width: 100%; border-collapse: collapse; margin-bottom: 20px;" >
