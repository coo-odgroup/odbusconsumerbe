...
--
-- Host: localhost
-- Generation Time: Jun 29, 2021 at 01:55 PM
...
--
ALTER TABLE `cancellationslabs_info`
  ADD CONSTRAINT `cancellationslab_id_FK` FOREIGN KEY (`cancellation_slab_id`) REFERENCES `cancellationslabs` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT;
